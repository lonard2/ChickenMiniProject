...
//  ChickenMiniProject
//
//  Created by Lonard Steven on 18/12/24.
//

import UIKit

final class HomepageView: UIViewController, GridViewControllerDelegate, UISearchBarDelegate {
    override func viewDidLayoutSubviews() {
        super.viewDidLayoutSubviews()
        horizontalFilterScrollView.contentSize = CGSize(width: horizontalFilterStackView.frame.width, height: horizontalFilterStackView.frame.height) // could be removed if any (cause this is just a workaround)
    }
    ...
    private var filterCategories: [String] = [] // store filter/area categories
    ...
    lazy var horizontalFilterStackView: UIStackView = {
    ...
    lazy var gridContainerView: UIView = {
        let view = UIView()
    ...
    // MARK: objc for exposing legacy code/code part/components yang Apple punya dulu-dulu
    ...
    private func setupUI() {
        ...
        // put the constraints into a setupView-like function or a lazy var (hati-hati saat initialize)
